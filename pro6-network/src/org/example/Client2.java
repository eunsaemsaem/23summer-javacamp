...
public class Client2 extends JPanel { /////// 검은돌/////////
        ...
        public void run() {
            ...
            while (in != null) {
                ...
                try {
                    ...
                    System.out.println("c2 name:" + as[0] + " x:" + as[1] + " y:" + as[2]);
                    enable = true;

                    if (rename.equals("player2")) {
                        return;
                    }
...
//					}
                    ...
                    System.out.println("c2 receiver - repaint이후 true인지/" + enable);
        ...
        public Othello1() {
            ...
            addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    if (!enable) {
                        System.out.println("c2 clicked false/" + enable);
                        return;
                    }
